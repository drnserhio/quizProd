...
export class QuizService {
  ...
  public deleteFromQuiz(quizId: number, questionId: number): Observable<boolean> {
    return this.http.get<boolean>(`${this.api}/delete_question_in_quiz/${quizId}/${questionId}`);
  }
}
